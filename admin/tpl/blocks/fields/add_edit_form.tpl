        ...
        <tr>
            ...
            <td class="field">
                <select name="phone[country]">
                    <option value="">{$lang.worldwide}</option>
                    {foreach from=$countries_list item='country_name' key='country_code'}
                        <option {if $phone.country == $country_code}selected="selected"{/if} value="{$country_code}">{$country_name}</option>
                    {/foreach}
                </select>
            </td>
        </tr>
        <tr>
            <td class="name">{$lang.phone_show_dial}</td>
            <td class="field">
                {if $phone.show_dial == '1'}
                    {assign var='show_dial_yes' value='checked="checked"'}
                {elseif $phone.show_dial == '0'}
                    {assign var='show_dial_no' value='checked="checked"'}
                {else}
                    {assign var='show_dial_yes' value='checked="checked"'}
                {/if}

                <label>
                    <input {$show_dial_yes} name="phone[show_dial]" type="radio" value="1" /> {$lang.yes}
                </label>
                <label>
                    <input {$show_dial_no}  name="phone[show_dial]" type="radio" value="0" /> {$lang.no}
                </label>
            </td>
        </tr>
        <tr>
            <td class="name">{$lang.phone_show_flag}</td>
            <td class="field">
                {if $phone.show_flag == '1'}
                    {assign var='show_flag_yes' value='checked="checked"'}
                {elseif $phone.show_flag == '0'}
                    {assign var='show_flag_no' value='checked="checked"'}
                {else}
                    {assign var='show_flag_yes' value='checked="checked"'}
                {/if}

                <label>
                    <input {$show_flag_yes} name="phone[show_flag]" type="radio" value="1" /> {$lang.yes}
                </label>
                <label>
                    <input {$show_flag_no}  name="phone[show_flag]" type="radio" value="0" /> {$lang.no}
                </label>
            </td>
        </tr>
        <tr>

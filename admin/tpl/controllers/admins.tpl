                                ...
                                {if $childKey|in_array:$extended_sections}
                                    <div style="margin: 2px 20px;" class="rule">
                                        ...
                                        {foreach from=$extended_modes item='mode'}
                                            <div class="{$mode}">
                                                <input {if is_array($pRights.$childKey) && $pRights.$childKey.$mode == $mode}checked="checked"{/if}
                                                    name="rights[{$nChild.Key}][{$mode}]"
                                                    value="{$mode}"
                                                    id="label__{$childKey}__{$mode}"
                                                    type="checkbox" />
                                                <label for="label__{$childKey}__{$mode}"
                                                    style="padding: 0;"> {$lang.$mode}</label>
                                            </div>
                                        {/foreach}
                                        <div class="clear"></div>
                                    </div>

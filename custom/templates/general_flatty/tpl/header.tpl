{include file='head.tpl'}
    ...
    <header class="solar-site-header">
        <section class="solar-header-shell">
            <div class="point1 d-flex align-items-center flex-wrap pl-3 pr-3 pl-md-0 pr-md-0 solar-header-row">
                ...
                <div class="top-user-navigation order-2 order-md-3 flex-fill flex-basis-0 d-flex justify-content-end">
                    ...
                    <a href="{pageUrl key='registration'}" class="solar-header-cta">List Your Company</a>
                </div>
            </div>
        </section>
        <section class="main-menu solar-main-nav">
